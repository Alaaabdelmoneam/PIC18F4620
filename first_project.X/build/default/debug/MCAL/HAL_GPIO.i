...
# 11 "MCAL/COMPILER.h" 2
# 12 "MCAL/STD_TYPES.h" 2
...
# 11 "MCAL/STD_LIBS.h" 2
# 13 "MCAL/STD_TYPES.h" 2
# 31 "MCAL/STD_TYPES.h"
...
# 14 "MCAL/HAL_GPIO.h" 2

# 1 "MCAL/DEVICE_CONFIG.h" 1
# 15 "MCAL/HAL_GPIO.h" 2
# 31 "MCAL/HAL_GPIO.h"
typedef enum {
    LOW,
    HIGH
...
Std_ReturnType gpio_pin_direction_initialize(const pin_config_t *_pin_config){
    ...
    if (((void*)0) == _pin_config || ((_pin_config->PORT) > (5 - 1)) || ((_pin_config->PIN) > (5)) ){
        ret = (Std_ReturnType)1;
    }
    else {
        ret = (Std_ReturnType)0;
        switch(_pin_config->dir)
        {
            case OUTPUT :
                (*TRIS[_pin_config->PORT] &= ~(1 << _pin_config->PIN));
                break;
            case INPUT :
                (*TRIS[_pin_config->PORT] |= (1 << _pin_config->PIN));
                break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config, direction_t *direction_status){
    Std_ReturnType ret = (Std_ReturnType)1;
    if (((void*)0) == _pin_config || ((void*)0) == direction_status || _pin_config->PORT > 5 || _pin_config->PIN > 8 ){
        ret = (Std_ReturnType)1;
    }
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic){
    Std_ReturnType ret = (Std_ReturnType)1;
    if (((void*)0) == _pin_config || _pin_config->PORT > 5 || _pin_config->PIN > 8 ){
        ret = (Std_ReturnType)1;
    }
    else {
        ret = (Std_ReturnType)0;
        ...
        {
            case LOW :
                (*LAT[_pin_config->PORT] &= ~(1 << _pin_config->PIN));
                break;
            case HIGH :
                (*LAT[_pin_config->PORT] |= (1 << _pin_config->PIN));
                break;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config, logic_t *logic){
    Std_ReturnType ret = (Std_ReturnType)1;
    if (((void*)0) == _pin_config || ((void*)0) == logic || _pin_config->PORT > 5 || _pin_config->PIN > 8 ){
        ret = (Std_ReturnType)1;
    }
