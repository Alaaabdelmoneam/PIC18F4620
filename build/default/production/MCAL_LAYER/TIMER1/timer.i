...
# 2 "<built-in>" 2
# 1 "MCAL_LAYER/TIMER1/timer.c" 2
# 12 "MCAL_LAYER/TIMER1/timer.c"
...
# 17 "MCAL_LAYER/TIMER1/../GPIO/../STD_TYPES.h"
# 1 "MCAL_LAYER/TIMER1/../GPIO/../STD_LIBS.h" 1
# 16 "MCAL_LAYER/TIMER1/../GPIO/../STD_LIBS.h"
...
# 16 "MCAL_LAYER/TIMER1/../GPIO/../STD_LIBS.h" 2
...
# 17 "MCAL_LAYER/TIMER1/../GPIO/../STD_LIBS.h" 2
...
# 18 "MCAL_LAYER/TIMER1/../GPIO/../STD_LIBS.h" 2
# 17 "MCAL_LAYER/TIMER1/../GPIO/../STD_TYPES.h" 2

# 1 "MCAL_LAYER/TIMER1/../GPIO/../COMPILER.h" 1
# 22 "MCAL_LAYER/TIMER1/../GPIO/../COMPILER.h"
...
# 22 "MCAL_LAYER/TIMER1/../GPIO/../COMPILER.h" 2
# 18 "MCAL_LAYER/TIMER1/../GPIO/../STD_TYPES.h" 2
# 61 "MCAL_LAYER/TIMER1/../GPIO/../STD_TYPES.h"
...
# 19 "MCAL_LAYER/TIMER1/../GPIO/HAL_GPIO.h" 2

# 1 "MCAL_LAYER/TIMER1/../GPIO/hal_gpio_cfg.h" 1
# 20 "MCAL_LAYER/TIMER1/../GPIO/HAL_GPIO.h" 2
...
# 13 "MCAL_LAYER/TIMER1/timer.h" 2

# 1 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERNAL_INTERRUPT.h" 1
# 15 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERNAL_INTERRUPT.h"
# 1 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERRUPT_CONFIG.h" 1
# 12 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERRUPT_CONFIG.h"
# 1 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERRUPT_GEN_CFG.h" 1
# 12 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERRUPT_CONFIG.h" 2
# 15 "MCAL_LAYER/TIMER1/../interrupts/MCAL_INTERNAL_INTERRUPT.h" 2
# 14 "MCAL_LAYER/TIMER1/timer.h" 2
...
# 12 "MCAL_LAYER/TIMER1/timer.c" 2
...
static __attribute__((inline)) void timer1_select_mode(Timer1_t *timer);
...
# 49 "MCAL_LAYER/TIMER1/timer.c"
        ...
        if(0x01 == timer1->oscilator_status){
            T1CONbits.T1OSCEN = 0x01;
        }
        else if (0x00 == timer1->oscilator_status){
            T1CONbits.T1OSCEN = 0x00;
        }
        else{ };
        if(0x00 == timer1->timer_bit_operation_mode){
            T1CONbits.RD16 = 0x00;
        }
        else if (0x01 == timer1->timer_bit_operation_mode){
            T1CONbits.RD16 = 0x01;
        }
        else{ };
...
static __attribute__((inline)) void timer1_select_mode(Timer1_t *timer){
    if(0x00 == timer->timer_or_counter_mode){
    T1CONbits.TMR1CS = 0x00;
    }
    else if (0x01 == timer->timer_or_counter_mode){
        T1CONbits.TMR1CS = 0x01;
        if(0x00 == timer->counter_mode_synchronization_status){
            T1CONbits.T1SYNC = 0x00;
        }
        else if (0x01 == timer->counter_mode_synchronization_status){
            T1CONbits.T1SYNC = 0x01;
        }
        else{ };
    }
    else{ };
