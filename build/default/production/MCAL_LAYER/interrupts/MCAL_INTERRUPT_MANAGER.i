# 1 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.c" 2
...
# 1 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.h" 1
# 11 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.h"
...
# 11 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.h" 2
...
# 8 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.c" 2
...
# 9 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.c" 2


static volatile uint8 RB4_Flag = 1, RB5_Flag = 1, RB6_Flag = 1, RB7_Flag = 1;
# 84 "MCAL_LAYER/interrupts/MCAL_INTERRUPT_MANAGER.c"
void __attribute__((picinterrupt(("")))) Interrupt_Manager(){
    ...
    if ((0x01 == PIE1bits.ADIE) && (0x01 == PIR1bits.ADIF))
    {
        ADC_ISR1();
    }
    else{ }

    if ((0x01 == INTCONbits.TMR0IE) && (0x01 == INTCONbits.T0IF))
    {
        Timer0_ISR();

    }
    else{ }
    if ((0x01 == PIE1bits.TMR1IE) && (0x01 == PIR1bits.TMR1IF))
    {
        Timer1_ISR();
    ...
    if ((0x01 == PIE1bits.TMR2IE) && (0x01 == PIR1bits.TMR2IF))
    {
        Timer2_ISR();
    ...
    if ((0x01 == PIE2bits.TMR3IE) && (0x01 == PIR2bits.TMR3IF))
    {
        Timer3_ISR();
