...
# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_TYPES.h" 1
# 17 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_TYPES.h"
# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 1
# 16 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_LIBS.h"
...
# 16 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 2
...
# 17 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 2
...
# 18 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 2
# 17 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_TYPES.h" 2

# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../COMPILER.h" 1
# 22 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../COMPILER.h"
# 1 "C:\\Program Files\\Microchip\\MPLABX\\v6.15\\packs\\Microchip\\PIC18Fxxxx_DFP\\1.4.151\\xc8\\pic\\include\\xc.h" 1
# 18 "C:\\Program Files\\Microchip\\MPLABX\\v6.15\\packs\\Microchip\\PIC18Fxxxx_DFP\\1.4.151\\xc8\\pic\\include\\xc.h"
...
# 24 "C:\\Program Files\\Microchip\\MPLABX\\v6.15\\packs\\Microchip\\PIC18Fxxxx_DFP\\1.4.151\\xc8\\pic\\include\\xc.h" 2
...
# 25 "C:\\Program Files\\Microchip\\MPLABX\\v6.15\\packs\\Microchip\\PIC18Fxxxx_DFP\\1.4.151\\xc8\\pic\\include\\xc.h" 2
...
# 34 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC18Fxxxx_DFP/1.4.151/xc8\\pic\\include\\xc.h" 2
# 22 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../COMPILER.h" 2
# 18 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_TYPES.h" 2
# 61 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/../STD_TYPES.h"
...
# 19 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2

# 1 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/hal_gpio_cfg.h" 1
# 20 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2
# 34 "MCAL_LAYER/ADC/../../MCAL_LAYER/GPIO/HAL_GPIO.h"
typedef enum {
    LOW,
    HIGH
}logic_t;
...
# 15 "MCAL_LAYER/ADC/../interrupts/MCAL_INTERNAL_INTERRUPT.h"
# 1 "MCAL_LAYER/ADC/../interrupts/MCAL_INTERRUPT_CONFIG.h" 1
# 12 "MCAL_LAYER/ADC/../interrupts/MCAL_INTERRUPT_CONFIG.h"
# 1 "MCAL_LAYER/ADC/../interrupts/MCAL_INTERRUPT_GEN_CFG.h" 1
# 12 "MCAL_LAYER/ADC/../interrupts/MCAL_INTERRUPT_CONFIG.h" 2
# 15 "MCAL_LAYER/ADC/../interrupts/MCAL_INTERNAL_INTERRUPT.h" 2
# 17 "MCAL_LAYER/ADC/adc.h" 2
# 72 "MCAL_LAYER/ADC/adc.h"
typedef enum{
    AN_0,
    AN_1,
    AN_2,
...
# 1 "MCAL_LAYER/ADC/../../ECU_LAYER/LED/LED.h" 1
# 17 "MCAL_LAYER/ADC/../../ECU_LAYER/LED/LED.h"
# 1 "MCAL_LAYER/ADC/../../ECU_LAYER/LED/LED_CFG.h" 1
# 17 "MCAL_LAYER/ADC/../../ECU_LAYER/LED/LED.h" 2
...
static void __attribute__((inline)) ADC_Enable_Input_Channel(const ANx_SELECTED_CHANNEL_t channel);
static void __attribute__((inline)) ADC_Select_Voltage_Source(const ADC_CONFIG_t* ADC);
static void __attribute__((inline)) ADC_Select_Data_Display_Format(const ADC_CONFIG_t* ADC);



static uint16 __attribute__((inline)) ADC_Get_Data(const ADC_CONFIG_t* ADC);
...
STD_ReturnType ADC_Init(const ADC_CONFIG_t* ADC){
    ...
    if (((void*)0) == ADC){
        ...
        ADCON1bits.PCFG = ADC->ANx_ACTIVATED_CHANNELS;
        ...
        ADCON0bits.CHS = ADC->ANx_SELECTED_CHANNEL;
...
STD_ReturnType ADC_Get_Conversion_Status(const ADC_CONFIG_t* ADC, uint8* conversion_done){
    STD_ReturnType ret = (STD_ReturnType) 0x00;
    if ((((void*)0) == ADC )|| (((void*)0) == conversion_done)){
        ret = (STD_ReturnType) 0X01;
    }
    else{
        *conversion_done = (uint8) !(ADCON0bits.GO_DONE);
    }
    return ret;
}
...
STD_ReturnType ADC_Get_Conversion_Data(const ADC_CONFIG_t* ADC, uint16* conversion_data){
    STD_ReturnType ret = (STD_ReturnType) 0x00;
    if ((((void*)0) == ADC )|| (((void*)0) == conversion_data)){
        ret = (STD_ReturnType) 0X01;
    }
    else{
        while (0 == !(ADCON0bits.GO_DONE));
        *conversion_data = ADC_Get_Data(ADC);
    }
    return ret;
}
# 174 "MCAL_LAYER/ADC/adc.c"
STD_ReturnType ADC_Conversion_Complete_Blocking_Operation(const ADC_CONFIG_t* ADC,
                                                 ANx_SELECTED_CHANNEL_t channel,
                                                 uint16* conversion_data){
    STD_ReturnType ret = (STD_ReturnType) 0x00;
...
# 272 "MCAL_LAYER/ADC/adc.c"
static void __attribute__((inline)) ADC_Select_Voltage_Source(const ADC_CONFIG_t* ADC){
    if (0 == ADC->VOLTAGE_SOURCE_USED){
        {ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG0 = 0;};
    }
    else{
        {ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG0 = 1;};
    }
}
# 288 "MCAL_LAYER/ADC/adc.c"
static void __attribute__((inline)) ADC_Select_Data_Display_Format(const ADC_CONFIG_t* ADC){
    if (0 == ADC->DATA_ALLIGNMENT_FORMAT){
        ADCON2bits.ADFM = 0;
    }
    else{
        ADCON2bits.ADFM = 1;
...
static uint16 __attribute__((inline)) ADC_Get_Data(const ADC_CONFIG_t* ADC){
    if (0 == ADC->DATA_ALLIGNMENT_FORMAT){
        return (uint16)(((ADRESL) | ((ADRESH) << 8)) >> 6);
    }
    else{
        return (uint16)((ADRESL) | ((ADRESH) << 8));
    }
}
# 324 "MCAL_LAYER/ADC/adc.c"
void ADC_ISR1(){
    PIR1bits.ADIF = 0;


    if (((void*)0) != ADC_Interrupt_Handler){ADC_Interrupt_Handler();}
}
void ADC_ISR2(){
    PIR1bits.ADIF = 0;
