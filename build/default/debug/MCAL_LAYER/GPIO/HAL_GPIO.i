...
# 17 "MCAL_LAYER/GPIO/../STD_TYPES.h"
# 1 "MCAL_LAYER/GPIO/../STD_LIBS.h" 1
# 16 "MCAL_LAYER/GPIO/../STD_LIBS.h"
...
# 16 "MCAL_LAYER/GPIO/../STD_LIBS.h" 2
...
# 17 "MCAL_LAYER/GPIO/../STD_LIBS.h" 2
...
# 18 "MCAL_LAYER/GPIO/../STD_LIBS.h" 2
# 17 "MCAL_LAYER/GPIO/../STD_TYPES.h" 2

# 1 "MCAL_LAYER/GPIO/../COMPILER.h" 1
# 22 "MCAL_LAYER/GPIO/../COMPILER.h"
...
# 22 "MCAL_LAYER/GPIO/../COMPILER.h" 2
# 18 "MCAL_LAYER/GPIO/../STD_TYPES.h" 2
# 61 "MCAL_LAYER/GPIO/../STD_TYPES.h"
...
# 20 "MCAL_LAYER/GPIO/HAL_GPIO.h" 2
...
STD_ReturnType gpio_pin_direction_init(const pin_config_t * pin){
    ...
    if (((void*)0) == pin || pin->PORT > 5 - 1 || pin->PIN > 8 - 1 )
    {
...
STD_ReturnType gpio_pin_direction_get_status(const pin_config_t * pin, direction_t* direction ){
    ...
    if (((void*)0) == pin || ((void*)0) == direction || pin->PORT > 5 - 1 || pin->PIN > 8 - 1 )
    {
        ret = (STD_ReturnType) 0X01;
    }
    else
...
STD_ReturnType gpio_pin_logic_read(const pin_config_t * pin, logic_t * logic ){
    ...
    if (((void*)0) == pin || ((void*)0) == logic || pin->PORT > 5 - 1 || pin->PIN > 8 - 1 )
    {
        ret = (STD_ReturnType) 0X01;
    }
    else
...
STD_ReturnType gpio_port_direction_get_status(port_index_t port, uint8* port_direction){
    ...
    if ( port > 5 - 1 || ((void*)0) == port_direction)
    {
        ret = (STD_ReturnType) 0X01;
    }
    else
...
# 284 "MCAL_LAYER/GPIO/HAL_GPIO.c"
STD_ReturnType gpio_port_logic_read(port_index_t port, uint8* port_logic){

    STD_ReturnType ret = (STD_ReturnType) 0x00;

    if ( port > 5 - 1 || ((void*)0) == port_logic)
    {
        ret = (STD_ReturnType) 0X01;
    }
    else
...
# 309 "MCAL_LAYER/GPIO/HAL_GPIO.c"
STD_ReturnType gpio_port_logic_toggle(port_index_t port){
