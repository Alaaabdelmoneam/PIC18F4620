...
# 2 "<built-in>" 2
# 1 "MCAL_LAYER/TIMER0/timer.c" 2
# 11 "MCAL_LAYER/TIMER0/timer.c"
...
# 17 "MCAL_LAYER/TIMER0/../GPIO/../STD_TYPES.h"
# 1 "MCAL_LAYER/TIMER0/../GPIO/../STD_LIBS.h" 1
# 16 "MCAL_LAYER/TIMER0/../GPIO/../STD_LIBS.h"
...
# 16 "MCAL_LAYER/TIMER0/../GPIO/../STD_LIBS.h" 2
...
# 17 "MCAL_LAYER/TIMER0/../GPIO/../STD_LIBS.h" 2
...
# 18 "MCAL_LAYER/TIMER0/../GPIO/../STD_LIBS.h" 2
# 17 "MCAL_LAYER/TIMER0/../GPIO/../STD_TYPES.h" 2

# 1 "MCAL_LAYER/TIMER0/../GPIO/../COMPILER.h" 1
# 22 "MCAL_LAYER/TIMER0/../GPIO/../COMPILER.h"
...
# 22 "MCAL_LAYER/TIMER0/../GPIO/../COMPILER.h" 2
# 18 "MCAL_LAYER/TIMER0/../GPIO/../STD_TYPES.h" 2
# 61 "MCAL_LAYER/TIMER0/../GPIO/../STD_TYPES.h"
...
# 19 "MCAL_LAYER/TIMER0/../GPIO/HAL_GPIO.h" 2

# 1 "MCAL_LAYER/TIMER0/../GPIO/hal_gpio_cfg.h" 1
# 20 "MCAL_LAYER/TIMER0/../GPIO/HAL_GPIO.h" 2
...
# 14 "MCAL_LAYER/TIMER0/timer.h" 2

# 1 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERNAL_INTERRUPT.h" 1
# 15 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERNAL_INTERRUPT.h"
# 1 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERRUPT_CONFIG.h" 1
# 12 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERRUPT_CONFIG.h"
# 1 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERRUPT_GEN_CFG.h" 1
# 12 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERRUPT_CONFIG.h" 2
# 15 "MCAL_LAYER/TIMER0/../interrupts/MCAL_INTERNAL_INTERRUPT.h" 2
# 15 "MCAL_LAYER/TIMER0/timer.h" 2
...
# 11 "MCAL_LAYER/TIMER0/timer.c" 2
...
static void(*Timer0_ISR_Callback)(void) = ((void*)0);
...
STD_ReturnType Timer0_Init(timer0_t *timer0){
    ...
    if (((void*)0) == timer0){
        ...
        if (0x01 == timer0->timer_8bit_mode){
            T0CONbits.T08BIT = 1;
        }
        else{
            T0CONbits.T08BIT = 0;
        }
        if (0x01 == timer0->counter_mode){
            T0CONbits.T0CS = 1;
            if (0x01 == timer0->counter_rising_edge){
            T0CONbits.T0SE = 0;
            }
            else{
                T0CONbits.T0SE = 1;
        ...
        if (0x01 == timer0->prescaler_enable){
            T0CONbits.PSA = 0;
