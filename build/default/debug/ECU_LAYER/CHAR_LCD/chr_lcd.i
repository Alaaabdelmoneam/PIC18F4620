# 1 "ECU_LAYER/CHAR_LCD/chr_lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_LAYER/CHAR_LCD/chr_lcd.c" 2
...
# 16 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/HAL_GPIO.h"
...
# 1 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_TYPES.h" 1
# 17 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_TYPES.h"
# 1 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 1
# 16 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_LIBS.h"
...
# 16 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 2
...
# 17 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 2
...
# 18 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_LIBS.h" 2
# 17 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_TYPES.h" 2

# 1 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../COMPILER.h" 1
# 22 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../COMPILER.h"
...
# 22 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../COMPILER.h" 2
# 18 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_TYPES.h" 2
# 61 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../STD_TYPES.h"
...
# 18 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2

# 1 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/../DEVICE_CONFIG.h" 1
# 19 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2

# 1 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/hal_gpio_cfg.h" 1
# 20 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/HAL_GPIO.h" 2
# 34 "ECU_LAYER/CHAR_LCD/../../MCAL_LAYER/GPIO/HAL_GPIO.h"
typedef enum {
    LOW,
    HIGH
}logic_t;
...
# 13 "ECU_LAYER/CHAR_LCD/chr_lcd.h" 2
...
# 9 "ECU_LAYER/CHAR_LCD/chr_lcd.c" 2
...
STD_ReturnType lcd_4bit_initialize(const chr_lcd_4bit_t * lcd){
    ...
    if (((void*)0) == lcd){
        ...
        lcd_4bit_send_command(lcd, 0x38);
        _delay((unsigned long)((50)*(8000000.0/4000000.0)));
        lcd_4bit_send_command(lcd, 0x38);
...
STD_ReturnType lcd_4bit_send_chr_custom_position(const chr_lcd_4bit_t * lcd, uint8 chr[], uint8 row, uint8 column, uint8 memory_position){
    ...
    if (((void*)0) == lcd){
        ...
        ret = lcd_4bits_set_cursor(lcd,row,column);
        ret = lcd_4bit_send_command(lcd,0x40 + 8 * memory_position);
...
STD_ReturnType lcd_8bit_send_chr_custom_position(const chr_lcd_8bit_t * lcd, uint8 chr[], uint8 row, uint8 column, uint8 memory_position){
    ...
    if (((void*)0) == lcd){
        ...
        ret = lcd_8bit_send_command(lcd,0x40 + 8 * memory_position);
        for (l_counter = 0; l_counter < 8; l_counter++){
